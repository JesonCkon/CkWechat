...
class CompanyPayments extends AbstractApi
{
  ...
  {
      $this->http->setUrl(ApiUrl::PROMOTION_TRANSFERS);
  ...
  public function makeSendData(array $params)
  {
      ...
      $this->send_data['mch_appid'] = $this->config->app_id;
      $this->send_data['mchid'] = $this->config->mch_id;
